    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 mt-6 sm:ml-10 sm:flex">
                    ...
                    <x-slot name="content">
                        ...
                        <div class="hidden   pt-2 space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                <div class="hidden space-x-8 mt-6 sm:ml-10 sm:flex">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <div class="hidden   pt-2 space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <x-nav-link :href="route('articles.myarticles')" :active="request()->routeIs('articles.myarticles')">
                                    {{ __('My Articles') }}
                                </x-nav-link>
                            </div>
